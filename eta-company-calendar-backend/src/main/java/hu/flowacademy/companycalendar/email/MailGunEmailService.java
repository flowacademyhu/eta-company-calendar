...
public class MailGunEmailService implements EmailService {
    ...
    @NonNull private final EmailFactory emailFactory;
    ...
    private void asyncSend(MultiValueMap<String, String> body, HttpHeaders headers) {
        try {
            ...
            ResponseEntity<String> response = restTemplate.postForEntity(mailingConfig.getMailgun().getMailSenderUrl() + "/messages",
